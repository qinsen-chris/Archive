...
public class DataSafety implements Serializable{
	private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(DataSafety.class);
	public long id;
	private long _id;
	...
	public void setId(long id){
		...
		try{
			...
			LOGGER.error("根据用户id查找用户明细表信息时：",e);
			this._id = -1;
			JPA.setRollbackOnly();
