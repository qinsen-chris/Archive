...
#缩放节点
az aks scale --resource-group gangtise-k8sGroup --name gangtiseCluster --node-count 10   
node_time=`date`
...
kubectl scale --replicas=5 StatefulSet/ignite  -n ignite
...
ignite_end=`date`
echo "ignite replicas=5 end : $ignite_end " >> /root/yaml/gangtiseClusterScale.txt
...
kubectl scale --replicas=2 deployment/gangtise-gateway-service  -n spring-app 
gateway_end=`date`
echo "pod gateway replicas=2 end : $gateway_end " >> /root/yaml/gangtiseClusterScale.txt
...
kubectl scale --replicas=2 deployment/gts-userdata-service  -n spring-app 
userdata_end=`date`
echo "pod userdata replicas=2 end : $userdata_end " >> /root/yaml/gangtiseClusterScale.txt

#spring-6 gts-userdata-dyqh-service
kubectl scale --replicas=2 deployment/gts-userdata-dyqh-service  -n spring-app 
userdata_dyqh_end=`date`
echo "pod userdata-dyqh replicas=2 end : $userdata_dyqh_end " >> /root/yaml/gangtiseClusterScale.txt
...
kubectl scale --replicas=2 deployment/gts-keyboard-yhty  -n spring-app 
keyboard_yhty_end=`date`
echo "pod gts-keyboard-search replicas=2 end : $keyboard_yhty_end " >> /root/yaml/gangtiseClusterScale.txt

#spring-9 gts-keyboard-gaze
kubectl scale --replicas=2 deployment/gts-keyboard-gaze  -n spring-app 
keyboard_gaze_end=`date`
echo "pod gts-keyboard-search replicas=2 end : $keyboard_gaze_end " >> /root/yaml/gangtiseClusterScale.txt

#spring-10 gts-keyboard-ea
kubectl scale --replicas=2 deployment/gts-keyboard-ea  -n spring-app 
keyboard_ea_end=`date`
echo "pod gts-keyboard-search replicas=2 end : $keyboard_ea_end " >> /root/yaml/gangtiseClusterScale.txt

#spring-11 gts-keyboard-common-search
kubectl scale --replicas=2 deployment/gts-keyboard-common-search  -n spring-app 
keyboard_common_end=`date`
echo "pod gts-keyboard-search replicas=2 end : $keyboard_common_end " >> /root/yaml/gangtiseClusterScale.txt

#spring-12 gts-info-service
kubectl scale --replicas=2 deployment/gts-info-service  -n spring-app 
gts_info_end=`date`
echo "pod gts-info-service replicas=2 end : $gts_info_end " >> /root/yaml/gangtiseClusterScale.txt

#spring-13 gts-info-service
kubectl scale --replicas=1 deployment/gts-article-search.yaml  -n spring-app 
gts_info_end=`date`
